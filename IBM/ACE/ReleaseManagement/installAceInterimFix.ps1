...
$installDir = "$installBasePath\$aceVersion"
$fullFixName = "$aceVersion-ACE-WinX64-$fixName"
Unzip-InterimFix -fixName $fullFixName

TestInstall-InterimFix -aceVersion $aceVersion -fixName $fullFixName  -installDir $installDir
Install-InterimFix -aceVersion $aceVersion -fixName $fullFixName  -installDir $installDir
