...
.EXAMPLE
    .\installAceModRelease.ps1 -fixVersion 12.0.7.0 -fixName TFIT42022 -installBasePath "C:\Program Files\ibm\ACE" -logBasePath "C:\temp" -runtimeBasePath "C:\ProgramData\IBM\MQSI"
    .\installAceModRelease.ps1 -fixVersion 12.0.7.0 -ixName TFIT42022 -installBasePath "D:\IBM\ACE" -logBasePath "C:\temp" -runtimeBasePath "D:\IBM\MQSI\Nodes"
...
Write-Log("End installAceInterimFix.")