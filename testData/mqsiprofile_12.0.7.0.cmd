...
set TOOLS_FILEPATH=%MQSI_BASE_FILEPATH%\tools

set MQSI_VERSION=12.0.7.0
set MQSI_VERSION_V=12
set MQSI_VERSION_R=0
set MQSI_VERSION_M=7
...
:: Source the java override profile if present
IF EXIST %MQSI_BASE_FILEPATH%\mqsijavaprofile.cmd (
  CALL %MQSI_BASE_FILEPATH%\mqsijavaprofile.cmd
  SET MQSI_JRE_OVERRIDDEN=1
)
echo.
echo MQSI %MQSI_VERSION%
echo %MQSI_FILEPATH%
echo.
rem  Custom values  [
set MQSI_FREE_MASTER_PARSERS=true
rem ]
